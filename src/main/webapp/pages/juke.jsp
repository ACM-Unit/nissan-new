                                                    ...
                                                    <div class="inner show">
                                                        <nav aria-label="main navigation">
                                                            <ul class="nav-primary">
                                                                <li class="active">
                                                                    <a href="/car-models/${car.name}"  data-adobe-tagging="vehicles|new|juke-ru">
        ...
        <div class="grid-row bleed">
            <div class="col-12">
                <div class="parsys col1-par"><div class="section vehicleIntro">
                    <div class="c_016 flush no-pricing" data-vehicle-model="Juke" data-vehicle-id="${car.modelcode}">
                    ...
                    <span itemprop="priceSpecification" itemscope="" itemtype="http://schema.org/UnitPriceSpecification">
                        ...
                        <figure>
                            ...
                            <span class="picture-element" data-alt=" ">
                                <span data-src="/car-models/${car.name}/colors/car-KY0.png" data-media="(min-width: 1.0em)" data-density="1"></span>
                                <span data-src="/car-models/${car.name}/colors/car-KY0.png" data-media="(min-width: 1.0em)" data-density="2"></span>
                                <span data-src="/car-models/${car.name}/colors/car-KY0.png" data-media="(min-width: 36.3125em)" data-density="1"></span>
                                <span data-src="/car-models/${car.name}/colors/car-KY0.png" data-media="(min-width: 36.3125em)" data-density="2"></span>
                                <span data-src="/car-models/${car.name}/colors/car-KY0.png" data-media="(min-width: 60.0em)" data-density="1"><img src="/car-models/${car.name}/colors/car-KY0.png" class="" alt=" "></span>
                                <span data-src="/car-models/${car.name}/colors/car-KY0.png" data-media="(min-width: 60.0em)" data-density="2"></span>
                                <noscript>
                                    <img alt="&#x20;" src="/car-models/${car.name}/colors/car-KY0.png"/>
                                </noscript>
                            </span>
                        </figure>
                        <div class="footer">
